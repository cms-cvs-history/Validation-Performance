...
mkdir ${i}_TimeSize
cd ${i}_TimeSize
${CMSSW_BASE}/src/Validation/Performance/test/SimulationCandles.pl 50 $i G4yes 12
...
${CMSSW_BASE}/src/Validation/Performance/test/SimulationCandles.pl 5 ZPrimeJJM700 G4no 3456
...
${CMSSW_BASE}/src/Validation/Performance/test/SimulationCandles.pl 1 ZPrimeJJM700 G4no 78
...
mkdir ${i}_Valgrind
cd ${i}_Valgrind
${CMSSW_BASE}/src/Validation/Performance/test/SimulationCandles.pl 1 $i G4no 78
